...
The system SHALL capture daily student attendance through scan or identifier input using first-scan check-in and second-scan check-out behavior.
...
The system SHALL show recent student attendance activity in an internal operational view for school staff.
