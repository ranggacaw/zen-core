...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/peserta-murid/create' },
];

function defaultValues(guardians: StudentCreateProps['guardians'], addressOptions: AddressOptions) {
    return {
        guardian_id: guardians[0] ? String(guardians[0].id) : '',
        school_class_id: '',
        name: '',
        student_number: '',
        status: 'active',
...
export default function StudentCreate({ guardians, classes, addressOptions }: StudentCreateProps) {
    const form = useForm(defaultValues(guardians, addressOptions));
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6 lg:p-8">
                ...
                <form
                    onSubmit={(event) => {
                        ...
                        form.post(route('students.store'), {
                            onSuccess: () => {
                                // Navigate back to index on success
                            },
                        });
                    }}
                ...
                >
                    ...
                    <div className="flex justify-end gap-2 border-t pt-4">
                        ...
                        <Button type="submit" disabled={form.processing || !guardians.length} className="bg-indigo-500 text-white hover:bg-indigo-600">
                            Create student
                        </Button>
                    </div>
                </form>
